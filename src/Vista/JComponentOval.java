...
public class JComponentOval extends JButton{
	...
	public JComponentOval(int valorOval, String text){
		this.setOpaque(false);
		this.setBorder(null);
		this.setContentAreaFilled(false);
		this.setFont(new Font("Calibri", Font.BOLD, 17));
	...
	public void addHover(Color color) {
		Color colorActual = this.getBackground();
    	this.addMouseListener(new MouseAdapter() {
    		@Override
    		public void mouseEntered(MouseEvent e) {
    			setBackground(color);
