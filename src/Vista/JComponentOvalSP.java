...
public class JComponentOvalSP extends JScrollPane{
		...
		public JComponentOvalSP(int valorEsquinaOvalSI, int valorEsquinaOvalSD, int valorEsquinaOvalII, int valorEsquinaOvalID){
		...
		public JComponentOvalSP(int valorOval){
			this.setOpaque(false);
			this.setBorder(null);
			this.setFont(new Font("Calibri", Font.BOLD, 17));
			this.setForeground(new Color(255, 255, 255));
		...
		public JComponentOvalSP(int valorOval, String text){
			this.setOpaque(false);
			this.setBorder(null);
			this.setFont(new Font("Calibri", Font.BOLD, 17));
			this.setForeground(new Color(255, 255, 255));
